...
const props = defineProps<{
  ...
  fileId: number
  peekMode?: boolean
  catalogSource?: { mediaType?: 'ebook' | 'comic'; remoteId: string; format: string }
...
const { pageCount, bookTitle, loading, error, pageUrl, load } = useCbz(props.fileId, props.bookId, { catalogSource: props.catalogSource })
