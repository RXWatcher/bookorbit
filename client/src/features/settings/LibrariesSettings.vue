          ...
          <div class="grid grid-cols-[auto_minmax(0,1fr)] items-start gap-3 md:flex md:items-center">
            ...
            <div class="col-span-2 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 md:flex md:shrink-0">
              ...
              >
                ...
                {{ sourceSyncingMap[lib.id] ? t('settings.admin.libraries.sourceSyncing') : t('settings.admin.libraries.sourceSync') }}
              </button>
              <button v-else class="settings-btn-outline justify-center md:justify-start" :disabled="isScanning(lib.id)" @click="scan(lib)">
